            ...
            using (SqlConnection connection = new SqlConnection(_options.Value.SqlConnectionString))
            {
                ...
                using (GridReader gr = await connection.QueryMultipleAsync(
                    @"SELECT cms.Element.TenantId, cms.Element.ElementId, cms.Element.ElementTypeId, cms.Element.Name,
                        ISNULL(element.NavBar.Name, '') AS Brand, element.NavBar.ShowLoggedOnUserOptions, element.NavBar.ShowLoggedOffUserOptions
                      ...
                      SELECT element.NavBarTab.NavBarTabId AS TabId, element.NavBarTab.Name, element.NavBarTab.PageId
