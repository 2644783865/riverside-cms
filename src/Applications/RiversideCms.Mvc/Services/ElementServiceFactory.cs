...
namespace RiversideCms.Mvc.Services
{
    public class ElementServiceFactory : IElementServiceFactory
    {
        ...
        {
            //IElementView<CodeSnippetElementSettings, ElementContent> view = await _codeSnippetElementService.ReadElementViewAsync(tenantId, 644, context);

            switch (elementTypeId.ToString())
            {
                case "5401977d-865f-4a7a-b416-0a26305615de":
                    return new Models.ElementView<CodeSnippetElementSettings>
                    {
                ...
                case "f1c2b384-4909-47c8-ada7-cd3cc7f32620":
                    return new Models.ElementView<FooterElementSettings, FooterElementContent>
                    {
                ...
                case "c92ee4c4-b133-44cc-8322-640e99c334dc":
                    return new Models.ElementView<HtmlElementSettings, HtmlElementContent>
                    {
                ...
                case "a94c34c0-1a4c-4c91-a669-2f830cf1ea5f":
                    return new Models.ElementView<NavigationBarElementSettings, NavigationBarElementContent>
                    {
                ...
                case "1cbac30c-5deb-404e-8ea8-aabc20c82aa8":
                    return new Models.ElementView<PageHeaderElementSettings, PageHeaderElementContent>
                    {
                ...
                case "61f55535-9f3e-4ef5-96a2-bc84d648842a":
                    return new Models.ElementView<PageListElementSettings, PageListElementContent>
                    {
                ...
                case "cf0d7834-54fb-4a6e-86db-0f238f8b1ac1":
                    return new Models.ElementView<ShareElementSettings, ShareElementContent>
                    {
